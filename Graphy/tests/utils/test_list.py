...
class TestList(unittest.TestCase):
    ...
    def test_diff(self):
        ...
        self.assertEqual(my_list.diff(list_2, list_1), list([3]))

        self.assertEqual(my_list.diff(list_1, list_3), list([2, 4]))

        self.assertEqual(my_list.diff(list_3, list_1), list([2, 4]))
